...
public class RegularAndJumboEnumSetExample {
    public static void main(String[] args) {
        // Using Regular EnumSet for a small enum
        EnumSet<SmallEnum> smallEnumSet = EnumSet.allOf(SmallEnum.class);
        System.out.println("Regular EnumSet for SmallEnum: " + smallEnumSet);

        // Using Jumbo EnumSet for a large enum
        EnumSet<LargeEnum> largeEnumSet = EnumSet.allOf(LargeEnum.class);
        System.out.println("Jumbo EnumSet for LargeEnum: " + largeEnumSet);
    }
}
