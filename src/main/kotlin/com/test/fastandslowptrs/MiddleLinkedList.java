package com.test.fastandslowptrs;

import com.test.ListNode;

public class MiddleLinkedList {

    public ListNode middleNodeFullTraversal(ListNode head) {
    ...
    public ListNode middleNode(ListNode head) {
        ...
        ListNode slow = head;
        ListNode fastX2 = head;
        while (fastX2.next.next != null) {
            slow = slow.next;
            fastX2 = fastX2.next.next;
        }
        return slow.next;
