...
public class MergeSortedArray {
    ...
    public void merge2(int[] nums1, int m, int[] nums2, int n) {
        // System.out.println("nums1 is " + Arrays.toString(nums1)+ " nums2 is " + Arrays.toString(nums2)
        // + " m is " + m + " n is "+n);
        int mergedIdx = m+n-1;
        int idx = m-1,jdx=n-1;
        while(jdx>=0 ){
            ...
            if(idx>=0 && nums2[jdx] < nums1[idx]){
                nums1[mergedIdx] = nums1[idx];
                idx--;
                mergedIdx--;
            } else{
                nums1[mergedIdx] = nums2[jdx];
                jdx--;
                mergedIdx--;
